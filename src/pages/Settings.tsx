...
const Settings: React.FC = () => {
  ...
  const mockUsers = [
    { id: '1', name: 'John Admin', email: 'admin@hotel.com', role: 'admin', status: 'active' },
    { id: '2', name: 'Sarah Receptionist', email: 'sarah@hotel.com', role: 'receptionist', status: 'active' },
    { id: '3', name: 'Mike Housekeeping', email: 'mike@hotel.com', role: 'housekeeping', status: 'active' },
    { id: '4', name: 'Lisa Kitchen', email: 'lisa@hotel.com', role: 'kitchen', status: 'inactive' }
  ];
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
            <div>
              ...
              <p className="text-sm text-gray-500">Download all hotel data as CSV</p>
            </div>
